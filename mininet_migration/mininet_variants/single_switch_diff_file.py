...
def main():
    ...
    print(h3.cmd('python3 ../tcp_thread/tcp_client_non_persistent.py 2 %s |& tee -a output.log &' %h1.IP()))
    print(h4.cmd('python3 ../tcp_thread/tcp_client_non_persistent.py 3 %s |& tee -a output.log &' %h1.IP()))
    print(h5.cmd('python3 ../tcp_thread/tcp_client_non_persistent.py 4 %s |& tee -a output.log &' %h1.IP()))
    print(h6.cmd('python3 ../tcp_thread/tcp_client_non_persistent.py 5 %s |& tee -a output.log &' %h1.IP()))
